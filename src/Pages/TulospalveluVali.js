  ...
  return (
    <div className='container'>
      <div className='container1'>
        <h2 className="header">VäliEra</h2>
      ...
      <div className="navbutton-container">
        ...
        <Link to="/TulospalveluFinaali" className={`${location.pathname === "/TulospalveluFinaali" ? "active" : ""}`}>
          <h2>Seuraava</h2>
        </Link>
      </div>
    </div>
...
export default TulospalveluVali;